...
const Testemonial = () => {
  ...
  return (
    <>
    <div id='features' className='flex flex-col items-center my-10 onScroll-mt-12'>
        <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 border rounded-full px-6 py-1.5">
            <BookUserIcon className="size4.5 stroke-green-600"/>
            <span>Testimonials</span>
        </div>
        <Title title="Do not just build your resume, create your story" description="Here's what our satisfied customers have to say about their experience with our resume builder." />
    </div>
