...
const ModernTemplate = ({ data, accentColor }) => {
	console.log("data in modern template", accentColor);
	...
	const summary = data.professional_summary || data.personal_summery;
							...
							<div className="space-y-4">
								{data.education.map((edu, index) => (
									<div key={index}>
										...
										<p style={{ color: accentColor }}>{edu.institution_name}</p>
